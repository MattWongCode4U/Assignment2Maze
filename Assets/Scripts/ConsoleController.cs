...
public class ConsoleController
{
    ...
    public ConsoleController()
    {
        ...
        registerCommand("reload", reload, "Reload the scene.");
        registerCommand("background", changeBackground, "Change the game's background.");
        registerCommand("playermaterial", playerMaterial, "Change the material on the players.");
    }
    ...
    void changeBackground(string[] args)
    {
        backgroundObj.GetComponent<Renderer>().material = (Material)Resources.Load("Materials/Background2");
    }

    void playerMaterial(string[] args)
    {
        p1.GetComponent<Renderer>().material = (Material)Resources.Load("Materials/AltP1");
        p2.GetComponent<Renderer>().material = (Material)Resources.Load("Materials/AltP2");
    }
